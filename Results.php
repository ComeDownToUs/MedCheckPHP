...
?>
		...
		<table class="log">
		<tr class="logrow"><td class="logcol1">Select Test Records</td>
...
<?php
if(isset($_POST['getDate'])){
	$testDetails = "SELECT r.RecordID, r.Date, r.MedBrand, r.Dose, d.FName, d.LName, r.Comments, r.DoctorID FROM RecordsDetail AS r
...
?>
		<table class="info">
		<tr><td class="infocol3">Test #</td><td class="infocol4"><?php echo("{$details[0]}"); ?></td></tr>
		<tr><td class="infocol3">Date</td><td class="infocol4"><?php echo("{$details[1]}");?></td></tr>
		<tr><td class="infocol3">Brand</td><td class="infocol4"><?php echo("{$details[2]}");?></td></tr>
		<tr><td class="infocol3">Dose (mg)</td><td class="infocol4"><?php echo("{$details[3]}");?></td></tr>
		<tr><td class="infocol3">Recorded by</td><td class="infocol4"><?php echo("{$details[4]} {$details[5]}");?></td></tr>
		</table></br>
<?php 
...
<?php
			...
			?>
				<tr><td class="infocol3"><?php echo("{$results[0]}");?></td>
				<td style="margin:0 auto 0 auto; display:block; width:35px;"> 
				<?php if($results[0]!="Blood Pressure DIA") { 
				/*
				Using jQuery UI dialog's to store a large amount of necessary information within a pop up window.
				With the image listed within a web link to function as a button so the even can be called to list out the neccessary data
				The content of the dialog is listed inside of the div.
				JavaScript code all located in the header.
				*/
				?>
				...
				<td class="infocol4"><?php echo("{$results[3]}");?></td></tr>
<?php 		} ?>
			</table>
<?php			mysql_free_result($displayResults);
		...
		<table class=info><tr><th class="infocol1">Comments</th></tr>
		<tr><td class="infocol4"><?php echo("{$details[6]}"); ?></td></tr>
		</table><br><br>
<?php
if($_SESSION['type']=="p"){
$_SESSION['practitioner']=$details[7];
		include "plugins/PatRel.php";
}
		} 
